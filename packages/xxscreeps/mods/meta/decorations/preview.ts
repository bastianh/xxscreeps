...
// from the property defaults instead and serves it like any other asset. Types that do have artwork
// — `wallGraffiti`, `creep`, `object` — keep whatever `preview` their pack declares.
...
/**
 * An svg standing in for a landscape decoration, or `undefined` when the definition is not a
 * landscape or does not carry the colours a drawing needs.
 */
