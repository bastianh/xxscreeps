	...
	"vector": {
		"struct": {
			...
			"type": {
				"offset": 0x4,
				"member": {
					"enum": [ "harvest", "reaction1", "reaction2", "reverseReaction1", "reverseReaction2", "attack", "attacked", "heal", "healed", "rangedAttack", "rangedHeal", "rangedMassAttack", "build", "repair", "produce", "reserveController", "upgradeController", "transferEnergy" ],
				},
			},
		},
	},
...
export const Controller = {
	...
	"struct": {
		...
		"#upgradeInvulnerableUntil": { "member": "int32", "offset": 0x3c },
		"isPowerEnabled": { "member": "bool", "offset": 0x44 },
		"safeModeAvailable": { "member": "int32", "offset": 0x40 },
	},
};
...
export const InvaderCore = {
	...
	"variant": "invaderCore",
	"struct": {
		"#actionLog": { "member": ActionLog, "offset": 0x28 },
		"#collapseTime": { "member": "int32", "offset": 0x30 },
		"#deployTime": { "member": "int32", "offset": 0x34 },
		"hits": { "member": "int32", "offset": 0x38 },
		"level": { "member": "int8", "offset": 0x3c },
	},
};
...
export const AnyObject = {
	"variant": [
		...
		{ "align": 4, "layout": Controller, "size": 69 },
		{ "align": 4, "layout": Link, "size": 68 },
		{ "align": 4, "layout": Storage, "size": 56 },
		{ "align": 4, "layout": InvaderCore, "size": 61 },
...
export const Room = {
	"struct": {
		...
		"#level": { "member": "int32", "offset": 0x40 },
		"#nextPowerBankTime": { "member": "int32", "offset": 0x44 },
		"#safeModeUntil": { "member": "int32", "offset": 0x4c },
					...
					"variant": [ {
						...
						"layout": {
							...
							"struct": {
								...
								"type": { "member": "string", "offset": 0x10 },
								"event": {
									"member": { "constant": 2 },
									"offset": 0x18,
								},
						...
						"layout": {
							...
							"struct": {
								...
								"objectId": { "member": Id, "offset": 0x0 },
								"resourceType": { "member": ResourceType, "offset": 0x24 },
						...
						"layout": {
							...
							"struct": {
								"objectId": { "member": Id, "offset": 0x0 },
								"room": { "member": "string", "offset": 0x10 },
								"x": { "member": "int8", "offset": 0x18 },
								"y": { "member": "int8", "offset": 0x19 },
								"event": {
									"member": { "constant": 10 },
									"offset": 0x1a,
								},
						...
						"layout": {
							"variant": 4,
							"struct": {
								"amount": { "member": "int32", "offset": 0x28 },
								"energySpent": { "member": "int32", "offset": 0x2c },
								"incomplete": { "member": "bool", "offset": 0x30 },
								"objectId": { "member": Id, "offset": 0x0 },
								"structureType": { "member": "string", "offset": 0x20 },
								"targetId": { "member": Id, "offset": 0x10 },
								"x": { "member": "int8", "offset": 0x31 },
								"y": { "member": "int8", "offset": 0x32 },
								"event": {
									"member": { "constant": 4 },
									"offset": 0x33,
								},
